...
public class AddUserForm {
    ...
    public static Target SALES_ROLE_OPTION = Target.the("sales option").locatedBy("//option[contains(text(),'Sales Team')]");
    public static Target CUSTOMER_ROLE_OPTION = Target.the("customer option").locatedBy("//option[contains(text(),'Customer')]");
    public static Target ADMIN_ROLE_OPTION = Target.the("admin option").locatedBy("//option[contains(text(),'Admin')]");
